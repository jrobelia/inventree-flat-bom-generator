# Flat BOM Generator- Frontend Code

This directory contains the frontend code for the Flat BOM Generator plugin.
...
This will compile the frontend into the `../flat_bom_generator/static` directory (ready for distribution).
