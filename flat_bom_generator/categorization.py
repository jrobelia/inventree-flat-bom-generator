...
def categorize_part(part_name: str, is_assembly: bool, is_top_level: bool = False, default_supplier_id: int = None, internal_supplier_ids: list = None, fab_prefix: str = 'fab', coml_prefix: str = 'coml') -> str:
    """
